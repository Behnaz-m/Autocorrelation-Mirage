...
The new mechanism-isolation table uses 30 paired replicates in each 2x2 cell. It finds positive gaps with episode effects and the temporal pathway toggled on or off, including 0.262 [0.233, 0.291] with both off; this is reported as evidence that shared event time and episode truncation remain a pathway rather than as a selective attribution claim.
